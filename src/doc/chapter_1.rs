...
RS-BASIC supports four types of data. This data is stored in a variable.
...
many quirks of BASIC that RS-BASIC preserves.
...
RS-BASIC supports the following operators, listed in order of precedence.
...
Arrays are sparse in RS-BASIC. This means you can dimension 32767 values but
...
RS-BASIC is a comprehensive implementation of early BASIC. Most programs only
