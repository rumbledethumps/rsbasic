...
Type CTRL-D to exit RS-BASIC. Stop a running program with CTRL-C.
...
current directory of your operating system when RS-BASIC was started.
...
reference material covering everything RS-BASIC can do. There's a lot of
...
suggestions for converting them to the RS-BASIC dialect.
