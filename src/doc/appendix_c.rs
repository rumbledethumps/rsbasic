...
RS-BASIC is a compiler. Lexical analysis is crippled to mimic
...
machine. The virtual machine is custom for RS-BASIC.
...
never hit a limit in RS-BASIC unless there's a bug in the BASIC
program.
...
Now you know why it's called RS-BASIC.
